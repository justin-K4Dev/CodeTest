...
# You can also use single quotes to assing a string.
...
print (len(astring))
#output: single quotes are ' '
#        12
# That prints out 12,
# because "Hello world!" is 12 characters long, including punctuation and spaces.


print ( astring.index("o") )
#output: 4
# That prints out 4,
# because the location of the first occurrence of the letter "o" is 4 characters away from the first character.
