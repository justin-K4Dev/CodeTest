...
{
    public class AsynchronousDelegate
    {
        ...
        static void asynchronous_delegate_what()
        {
            /*
                ...
                BeginInvoke()는 쓰레드를 구동시킨 후 IAsyncResult 객체를 리턴하고
                즉시 메인쓰레드의 다음 문장을 실행하게 된다.
