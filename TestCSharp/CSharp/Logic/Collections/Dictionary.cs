...
namespace Collections
{
    public class Dictionary
    {
		...
		static void dictionary_key_compare()
		{
			...
			bool result = customDic.Contains(elementToFind, new CustomComparer()); // returns true
		...
		static void dictionary_custom_key()
        {
            ...
            //var obj4 = entityDic[new EntityKey(4, "test")]; // KeyNotFoundException
